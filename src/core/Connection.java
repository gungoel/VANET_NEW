...
public abstract class Connection {
	...
	protected DTNHost name;
	protected DTNHost vehicleNum;
	protected int bytesTransferred;
	protected DTNHost direction;
	
	
	
	public DTNHost getVehicleNum() {
		return vehicleNum;
	}


	public void setVehicleNum(DTNHost vehicleNum) {
		this.vehicleNum = vehicleNum;
	}


	public DTNHost getName() {
		return name;
	}


	public void setName(DTNHost name) {
		this.name = name;
	}
